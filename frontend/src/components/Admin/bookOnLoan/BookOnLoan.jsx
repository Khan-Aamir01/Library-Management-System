...
export default function BookOnLoan() {
  ...
  return (
    <div className="flex flex-col md:justify-start justify-center items-center py-8 px-2">
      <div className="text-white bg-[rgb(14,25,40)] border-slate-500 shadow-md rounded px-2 py-2 md:px-8 md:pt-6 md:pb-8 mb-4 w-full flex flex-col text-center">
